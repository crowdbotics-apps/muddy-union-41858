"""
Django settings for muddy_union_41858 project.
...
ROOT_URLCONF = 'muddy_union_41858.urls'
...
WSGI_APPLICATION = 'muddy_union_41858.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_union_41858 API",
    "DESCRIPTION": "API documentation for muddy_union_41858 App",
    "VERSION": "v1",
}
